...
{
    internal static class OpenRouterImageApiConfig
    {
        internal const string BASE_URL = "https://openrouter.ai/api/v1";
        internal const string IMAGE_ENDPOINT = "/chat/completions";
        internal const string DEFAULT_IMAGE_MODEL = "google/gemini-2.5-flash-image";
